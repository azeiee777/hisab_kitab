...
public class DoorFragment extends Fragment {
       ...
       // return inflater.inflate(R.layout.fragment_door, container, false);
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                visibleViews();
                float result_feet = l*w*p/144f;
                float result_money = result_feet*r;
                tvTotalFeetResult.setText(String.valueOf(result_feet));
                tvTotalMoneyResult.setText(String.valueOf(result_money));
            }
        });
    ...
    private void updateViewsForLanguage() {
        if (ProductActivity.getLanguage().equals("hindi")) {
            ...
            ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle(R.string.door_hindi);
            ...
            ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle(R.string.door_english);
